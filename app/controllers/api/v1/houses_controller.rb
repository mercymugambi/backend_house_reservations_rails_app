...
swagger_path '/houses' do
  ...
  swagger_schema :House do
    key :required, [:id, :house_name, :city, :description, :bedrooms, :bathrooms, :rent, :security_deposit, :contact_phone_number, :admin_user_id]
    property :id do
      key :type, :integer
    end
  end
  ...
  swagger_schema :HouseInput do
    key :required, [:house_name, :city, :description, :bedrooms, :bathrooms, :rent, :security_deposit, :contact_phone_number, :admin_user_id]
